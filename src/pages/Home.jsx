            ...
            <div className="marquee-content">
              <div className="brand-logo-wrapper logo-grabfood">
                <svg className="brand-logo-svg" viewBox="0 0 165 35" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <text x="40" y="24" fontFamily="var(--font-heading)" fontWeight="800" fontSize="20" fill="currentColor" letterSpacing="-0.5">Food</text>
                </svg>
              </div>
              <div className="brand-logo-wrapper logo-stories">
                <svg className="brand-logo-svg" viewBox="0 0 145 35" xmlns="http://www.w3.org/2000/svg">
                  <text x="10" y="24" fontFamily="var(--font-heading)" fontWeight="600" fontSize="19" fill="currentColor" letterSpacing="0.5">
              ...
              <div className="brand-logo-wrapper logo-ondc">
                <svg className="brand-logo-svg" viewBox="0 0 125 35" xmlns="http://www.w3.org/2000/svg">
                  <g transform="translate(5, 4)">
                    <path d="M 15 8 A 9 9 0 0 0 15 26" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" />
                    <path d="M 19 26 A 9 9 0 0 0 19 8" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" />
                    <circle cx="15" cy="8" r="2.5" fill="currentColor" />
                    <circle cx="19" cy="26" r="2.5" fill="currentColor" />
                  </g>
                  <text x="40" y="24" fontFamily="var(--font-heading)" fontWeight="800" fontSize="21" fill="currentColor" letterSpacing="0.2">ONDC</text>
                </svg>
              </div>
              <div className="brand-logo-wrapper logo-rapido">
                <svg className="brand-logo-svg" viewBox="0 0 130 35" xmlns="http://www.w3.org/2000/svg">
                  <rect className="rapido-bg" x="5" y="4" width="115" height="27" rx="8" fill="currentColor" opacity="0.15" />
                  <g transform="skewX(-10)">
                    <text className="rapido-text" x="58" y="23" textAnchor="middle" fontFamily="var(--font-heading)" fontWeight="900" fontSize="19" fill="currentColor" letterSpacing="-0.5">rapido</text>
                  </g>
                </svg>
              </div>
